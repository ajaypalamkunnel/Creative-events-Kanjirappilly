...
export default function Services() {
  ...
  return (
    <section id="services" className="relative py-20 sm:py-28 overflow-hidden bg-brand-darker">
      ...
      <div className="absolute bottom-10 left-0 w-96 h-96 bg-brand-accent/20 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <SectionHeading
          ...
          description="From grand wedding stages and traditional Mandapams to intimate betrothals and corporate events, explore our comprehensive services in Kanjirappilly and Kottayam."
        />
            ...
            <ScrollReveal key={service.id} delay={idx * 0.05}>
              ...
              >
                ...
                <div className="relative w-full h-48 sm:h-52 overflow-hidden">
                  ...
                  {/* Pricing tag if present and not in badge */}
                  {service.pricing && !service.badge && (
                    <div className="absolute top-3 left-3 px-2.5 py-1 rounded-full bg-black/70 backdrop-blur-md border border-white/20 text-brand-goldLight text-[11px] font-semibold flex items-center gap-1">
        ...
        <div className="mt-16 text-center">
          <GlassCard variant="gold-tint" className="max-w-4xl mx-auto p-8 sm:p-10 text-center border-brand-gold/40">
            <h3 className="font-serif text-2xl sm:text-3xl font-bold text-white">
              Need a Custom Setup for Your Special Day?
            </h3>
            <p className="text-slate-300 text-sm sm:text-base mt-2 max-w-xl mx-auto">
              Tell us your theme, location, and preferred style. Our planners will provide customized concepts and proposals in Kanjirappilly and Kottayam.
            </p>
            ...
            <div className="relative w-full h-56 sm:h-72 rounded-2xl overflow-hidden mb-6 border border-white/10">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <span className="text-xs uppercase tracking-widest text-brand-gold font-bold">
                  {selectedService.pricing || "Service Specification"}
                </span>
                <h3 className="font-serif text-2xl sm:text-3xl font-bold text-white">
