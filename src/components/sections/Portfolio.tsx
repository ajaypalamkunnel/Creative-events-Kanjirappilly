...
export default function Portfolio() {
  ...
  return (
    <section id="portfolio" className="relative py-20 sm:py-28 overflow-hidden bg-brand-darker">
      ...
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-brand-accent/20 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <SectionHeading
          ...
          description={`Explore our signature wedding stages, reception canopies, and betrothal setups executed across Kanjirappilly, Kottayam, and premier venues in Kerala.`}
        />
        ...
        <div className="mb-20">
          <div className="text-center mb-6">
            ...
            <p className="text-xs sm:text-sm text-slate-300 mt-1 max-w-lg mx-auto">
              See how our artisanal floral and illumination styling converts event spaces into magical dream realms.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <BeforeAfter
              ...
              beforeLabel="Pre-Event Stage Setup"
              afterLabel="Signature Grand Stage"
            />
          </div>
        </div>
