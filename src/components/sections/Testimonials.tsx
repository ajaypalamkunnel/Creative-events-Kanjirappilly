...
import { testimonialsData, siteConfig } from "@/config/site";
    ...
    <section id="testimonials" className="relative py-20 sm:py-28 overflow-hidden bg-brand-darker">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <SectionHeading
          ...
          highlight="Families in Kerala"
          description={`Read genuine experiences from families who trusted ${siteConfig.business_name} with their once-in-a-lifetime milestones.`}
        />
