...
import { Sparkles, Calendar, Play, Star, MapPin, ChevronDown, Eye } from "lucide-react";
...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[92svh] sm:min-h-[100svh] flex items-center justify-center pt-28 pb-8 sm:pt-40 sm:pb-10 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="relative w-full h-full block sm:hidden">
          <Image
            ...
            alt={`${siteConfig.business_name} Mobile Stage View`}
            fill
            priority
        ...
        <div className="relative w-full h-full hidden sm:block">
          <Image
            ...
            alt={`${siteConfig.business_name} Grand Stage Decoration in Kanjirappilly Kottayam`}
            fill
            priority
      ...
      <div className="absolute bottom-1/4 right-1/4 w-64 sm:w-80 h-64 sm:h-80 bg-brand-accent/15 rounded-full blur-[110px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center mt-6 sm:mt-8">
        ...
        <p className="mt-2 sm:mt-3.5 text-xs sm:text-base md:text-lg text-slate-200/90 max-w-xl sm:max-w-2xl leading-relaxed font-normal drop-shadow">
          Professional wedding planning, elegant event decorations, and bespoke stage design crafted across Kanjirappilly, Kottayam & Kerala.
        </p>
        ...
        <div className="flex items-center justify-center gap-2 sm:gap-3 mt-3 sm:mt-4 text-[11px] sm:text-xs text-slate-200">
          <div className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-brand-dark/70 backdrop-blur-md border border-white/15">
            ...
            <span>Kanjirappilly • Kottayam</span>
          </div>
          <div className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-brand-dark/70 backdrop-blur-md border border-white/15">
