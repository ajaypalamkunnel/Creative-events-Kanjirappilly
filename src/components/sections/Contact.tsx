...
export default function Contact() {
    ...
    try {
      ...
      try {
        confetti({
          ...
          spread: 70,
          origin: { y: 0.6 },
          colors: ["#C9A24D", "#E8C97A", "#7C5CFF", "#FFFFFF"],
        });
      } catch (e) {
  ...
  return (
    <section id="contact" className="relative py-20 sm:py-28 overflow-hidden bg-brand-darker">
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-brand-accent/20 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <SectionHeading
          ...
          description="Have a date in mind or want to explore customized stage & event concepts? Send us your details or reach out directly to our Kanjirappilly team."
        />
          ...
          <div className="lg:col-span-5 space-y-6">
            <ScrollReveal direction="right">
              <GlassCard variant="elevated" className="p-6 sm:p-8 space-y-6 border-brand-gold/30">
                <div className="flex items-center justify-between pb-4 border-b border-white/10">
                  ...
                  >
                    ...
                    />
                    <span>{isOpenNow ? "Open Now" : "By Appointment"}</span>
                  </div>
                </div>
                ...
                <div className="space-y-4 text-sm text-slate-300">
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      <div className="font-semibold text-white">Contact Numbers</div>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 text-xs text-slate-300 mt-1">
                        {siteConfig.contact.phones.map((phone, pIdx) => (
                          <a
                            key={pIdx}
                            href={`tel:${phone}`}
                            className="hover:text-brand-goldLight transition-colors font-mono"
                          >
                            {phone}
                          </a>
                        ))}
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-xs text-slate-300 hover:text-brand-gold mt-0.5 block break-all"
                      >
              ...
              <div className="rounded-2xl overflow-hidden border border-brand-gold/30 shadow-xl h-48 sm:h-60 relative">
                <iframe
                  title={`${siteConfig.business_name} Kanjirappilly Map`}
                ...
                {submitSuccess ? (
                  <div className="py-12 text-center space-y-4 animate-fadeIn">
                    ...
                    <p className="text-sm text-slate-300 max-w-md mx-auto leading-relaxed">
                      Thank you for contacting {siteConfig.business_name}. Our event planning team in Kanjirappilly will review your requirements and reach out to you within 24 hours.
                    </p>
                    <button
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        >
                          ...
                          {servicesData.map((srv) => (
                            <option key={srv.id} value={srv.name}>
                              {srv.name} {srv.pricing ? `(${srv.pricing})` : ""}
                            </option>
                          ))}
                        </select>
                        {errors.service && (
                    ...
                    <div>
                      ...
                      <textarea
                        rows={4}
                        placeholder="Please share details about your venue location (e.g. Kanjirappilly, Kottayam, Ponkunnam), theme preferences, or specific decoration requirements..."
                        {...register("message")}
