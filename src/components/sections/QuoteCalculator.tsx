...
const eventTypes = [
  { id: "wedding", name: "Wedding Planning & Stage Decor", base: 120000 },
  { id: "reception", name: "Evening Reception & Lounge", base: 75000 },
  { id: "engagement", name: "Engagement / Betrothal Setup", base: 25000 },
  { id: "mandap", name: "Traditional Mandap / Altar Stage", base: 45000 },
  { id: "birthday", name: "Private Milestone / Birthday Party", base: 12000 },
  { id: "corporate", name: "Corporate Event & Conference", base: 80000 },
];

const guestScales = [
  { id: "intimate", label: "Under 200 Guests", multiplier: 1.0 },
  { id: "medium", label: "200 – 500 Guests", multiplier: 1.3 },
  { id: "grand", label: "500 – 1000 Guests", multiplier: 1.65 },
  { id: "royal", label: "1000+ Guests (Mega Hall)", multiplier: 2.1 },
];

const decorTiers = [
  { id: "classic", name: "Classic Elegance", desc: "Refined drapes, fresh florals, warm ambient lighting", cost: 15000 },
  { id: "pastel", name: "Pastel Garden Theme", desc: "Floral arches, circular backdrop rings, fairy lights", cost: 35000 },
  { id: "royal", name: "Royal Luxury Pavilion", desc: "Suspended floral clouds, crystal chandeliers, stage illumination", cost: 75000 },
];

const extraOptions = [
  { id: "tunnel", name: "Cascading Floral Entrance Archway", cost: 25000 },
  { id: "pyro", name: "Cold-Spark Pyros & Low Fog Couple Entrance", cost: 15000 },
  { id: "signage", name: "Personalized LED Neon Monogram & Welcome Easel", cost: 8000 },
  { id: "concierge", name: "Dedicated Event Day Coordination Team", cost: 15000 },
];
...
export default function QuoteCalculator() {
  ...
  const whatsappInquiryUrl = `https://wa.me/${siteConfig.contact.whatsapp.replace(/[^0-9]/g, "")}?text=${encodeURIComponent(
    `Hello Creative Events, I generated an event estimation online: \n\n${summaryText}\n\nCould you please share a detailed proposal and date availability?`
  )}`;
  ...
  return (
    <section id="quote-calculator" className="relative py-20 sm:py-28 overflow-hidden bg-brand-dark/90">
      ...
      <div className="absolute bottom-10 left-0 w-96 h-96 bg-brand-accent/20 rounded-full blur-[150px] pointer-events-none" />
            ...
            <ScrollReveal direction="left">
              <GlassCard variant="gold-tint" className="p-6 sm:p-8 border-brand-gold/50 shadow-2xl">
                ...
                <p className="text-[11px] text-slate-400 mt-1">
                  *Indicative baseline tailored to Kanjirappilly, Kottayam & Central Kerala venues.
                </p>
