...
import { whyChooseUsData, siteConfig } from "@/config/site";
  ...
  return (
    <section id="why-us" className="relative py-20 sm:py-28 overflow-hidden bg-brand-dark/60">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <SectionHeading
          eyebrow="The Creative Advantage"
          title="Why Families & Couples Choose"
          highlight="Creative Events"
          description="We bring creativity, personalized planning, and elegant styling together to create celebrations that reflect each client's unique dream, personality, and vision."
        />
            ...
            <GlassCard variant="elevated" className="p-6 sm:p-10 border-brand-gold/40">
              <div className="text-center mb-8">
                ...
                <h3 className="font-serif text-2xl sm:text-3xl font-bold text-white mt-1">
                  How Creative Events Delivers Greater Value
                </h3>
              </div>
                ...
                {[
                  {
                    ...
                    creative: "Personalized concept sketches & tailored floral layouts",
                    others: "Generic catalog templates or outdated photos",
                  },
                  {
                    aspect: "Floral Freshness",
                    creative: "Direct farm sourcing with peak freshness guaranteed all day",
                    others: "Stored in open heat; prone to mid-event wilting",
                  },
                  {
                    aspect: "Coordination & Management",
                    creative: "Dedicated event manager handling timing, decor, and cues",
                    others: "Fragmented responsibility left to stressful family members",
                  },
                  {
                    aspect: "Pricing & Transparency",
                    creative: "Clear upfront proposals starting ₹8,000 with zero surprise costs",
                    others: "Hidden transportation, labor, and sudden add-ons",
                  },
                ].map((row, idx) => (
                  <div
                    key={idx}
