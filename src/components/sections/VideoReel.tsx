...
const videoReels = [
  {
    ...
    subtitle: "Dynamic Live Stage Ambiance in Kanjirappilly",
  ...
  },
  {
    ...
    subtitle: "Complete Venue Styling & Royal Stage Finish",
    ...
    <section id="video-reel" className="relative py-20 sm:py-28 overflow-hidden bg-brand-dark/80">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <SectionHeading
          ...
          description={`Experience the atmosphere, illumination, and emotional grandeur of real celebrations orchestrated by ${siteConfig.business_name}.`}
        />
